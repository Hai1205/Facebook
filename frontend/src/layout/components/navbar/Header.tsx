        ...
        <div className="w-full flex justify-between items-center">
          ...
          <div className="flex md:flex items-center justify-center gap-4 md:gap-10 absolute left-1/2 transform -translate-x-1/2">
            {navItems.map(({ icon: Icon, path, name }) => (
              <button
                key={name}
                className={`relative p-2 md:p-3 text-gray-400 hover:text-white hover:bg-gray-800 rounded-md ${activeTab === name ? "text-blue-500" : ""
                  }`}
                onClick={() => handleNavigation(path, name)}
              >
                <Icon
                  className={`h-5 md:h-6 w-5 md:w-6 ${activeTab === name ? "text-blue-500" : ""
                    }`}
                />
                {activeTab === name && (
              ...
              <>
                <div className="relative">
                  <Button
                    ...
                    className={`rounded-full bg-gray-800 text-white hover:bg-gray-800 ${showNotifications
                ...
                <div className="relative">
                  <Button
                    ...
                    className={`rounded-full bg-gray-800 text-white hover:bg-gray-800 ${showMessages
                        ? "bg-[#1877F2]/20 text-blue-500"
                        : "hover:bg-gray-800 bg-zinc-800 text-gray-300"
                      }`}
                  >
