...
public class CloudinaryService {
    ...
    private static final String FOLDER_NAME = "Facebook";
    ...
    public List<Map<String, Object>> uploadMultipleFiles(List<MultipartFile> files) {
    ...
    public List<Map<String, Object>> deleteMultipleFiles(List<String> publicIds) {
        List<Map<String, Object>> results = new ArrayList<>();
        ...
        for (String publicId : publicIds) {
            results.add(deleteFile(publicId));
        }
