...
import com.backend.entities.Noti;
import com.backend.exceptions.OurException;
import com.backend.repositories.NotiRepository;
...
public class UsersApi {
    ...
    public Response updateUser(String userId,
        ...
        try {
            ...
            if (dateOfBirth != null && !dateOfBirth.isEmpty()
                    && !dateOfBirth.equals(user.getDateOfBirth().toString())) {
    ...
    public Response createUser(String email, String fullName, String password, String gender, String dateOfBirth,
            String role) {
        Response response = new Response();
