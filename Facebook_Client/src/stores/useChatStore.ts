...
interface ChatStore {
  ...
  sendMessageWithImages: (formData: FormData) => Promise<any>;
  sendMessageWithFiles: (formData: FormData) => Promise<any>;
  markMessageAsDeleted: (messageId: string, userId: string) => Promise<any>;
...
export const useChatStore = create<ChatStore>()(
  persist(
    (set, get) => ({
      ...
      sendMessageWithImages: async (formData: FormData) => {
        set({ isLoading: true, error: null });
      ...
      sendMessageWithFiles: async (formData: FormData) => {
        set({ isLoading: true, error: null });
      ...
      markMessageAsDeleted: async (messageId: string, userId: string) => {
        set({ isLoading: true, error: null });

        try {
          await markMessageAsDeleted(messageId, userId);
